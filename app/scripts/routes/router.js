...
Toptrending.Routers = Toptrending.Routers || {};

(function () {
  'use strict';

    Toptrending.Routers.Router = Backbone.Router.extend({
    controller: null
    , currentView: null
    , currentModal: null
    , history: []
    ...
    , initialize: function (options) {
      ...
      this.$app = $('<div class="toptrending"/>');
      this.$modal = $('<div />');
    ...
    , setCurrentModal: function (view) {
      ...
      var modal = new Toptrending.Views.Modal({
     ...
     */
    , home: function () {
      var view = new Toptrending.Views.Home({
    ...
    , error: function (name) {
      ...
      var view = new Toptrending.Views.Error({
        model: data
        , controller: this.controller
      });
    ...
    , loading: function (name) {
      ...
      var view = new Toptrending.Views.Loading({
        model: data
        , controller: this.controller
      });
      this.setCurrentModal(view);
