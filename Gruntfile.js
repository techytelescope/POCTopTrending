...
//            }
        ...
        jst: {
            compile: {
                options: {
                    ...
                    namespace: 'Toptrending.Templates'
                },
                files: {
    ...
    grunt.registerTask('createDefaultTemplate', function () {
        grunt.file.write('app/scripts/tmp/templates.js', 'window.Toptrending = window.Toptrending || {}; window.Toptrending.Templates = window.Toptrending.Templates || {};');
    });
